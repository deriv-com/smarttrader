export const contractExplanationData = {
    winning: {
        ...
        digits: {
            title  : 'Winning the contract',
            content: [
                'If you select "Matches", you will win the payout if the <strong>last digit</strong> of the last tick is the <strong>same</strong> as your <strong>prediction.',
                'If you select "Differs", you will win the payout if the <strong>last digit</strong> of the last tick is <strong>not the same</strong> as your <strong>prediction',
            ],
        },
        endsinout: {
            title  : 'Winning the contract',
        ...
        evenodd: {
            title  : 'Winning the contract',
            content: [
                'If you select "Even", you will win the payout if the <strong>last digit</strong> of the last tick is an <strong>even number (i.e., 2, 4, 6, 8, or 0).',
        ...
        runs: {
            title  : 'Winning the contract',
            content: [
                'If you select <strong>"Only Ups"</strong>, you win the payout if consecutive ticks rise successively after the <strong>entry spot</strong>.[_3]No payout if any tick falls or is equal to any of the previous ticks.',
                'If you select <strong>"Only Downs"</strong>, you win the payout if consecutive ticks fall successively after the <strong>entry spot</strong>.[_3]No payout if any tick rises or is equal to any of the previous ticks.',
            ],
        },
    },
    image: {
