...
const ViewPopup = (() => {
    ...
    const update = async () => {
        ...
        if (current_spot) {
            ...
            dataManager.setPurchase({
                cd_current_spot     : current_spot,
                cd_show_current_spot: true,
            });
    ...
    const appendAuditLink = (element_id) => {
        const link = Utility.createElement('a', { class: 'link-audit btn btn__small btn--secondary' });
