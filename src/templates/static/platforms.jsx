        ...
        <div className='fill-bg-color gr-padding-30' data-show='-eucountry'>
            <div className='container gr-padding-30 gr-child'>
                ...
                <div className='center-text'>
                    ...
                    <p><a className='button' href={`https://${it.derivDomainName()}/interim/faq/?utm_source=binary&utm_medium=referral&utm_campaign=deriv-launch&utm_content=page-platforms-banner`} target='_blank' rel='noopener noreferrer'><span>{it.L('Learn more about Deriv.com')}</span></a></p>
                </div>
            </div>
        </div>
                    ...
                    <TabContentContainer>
                        <TabContent id='beginner'>
                            <Platforms
                                ...
                                buttons={[
                                    { text: it.L('Try Deriv.com now'), url: `https://app.$${it.derivDomainName()}/?utm_source=binary&utm_medium=referral&utm_campaign=deriv-launch&utm_content=page-platforms-button-trade-now`, target: '_blank' },
                                ]}
                            />
                            <Platforms
                                image='trading-page'
