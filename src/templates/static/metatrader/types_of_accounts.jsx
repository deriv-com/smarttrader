    ...
    <div data-show='-eucountry' id='mt5_types_of_accounts' className='static_full'>
        ...
        <div id='content_types' className='invisible'>
            ...
            <Box
                ...
                image='financial'
                title={it.L('Financial')}
                text={it.L('The Financial account offers new and experienced traders high leverage and variable spreads for maximum flexibility. Trade major (standard and micro-lots) and minor currency pairs, stocks, stock indices, basket indices, commodities, and cryptocurrencies with high leverage.')}
            />
            <Box
                className='hide-maltainvest'
                image='financial_stp'
                    ...
                    <Table
                        ...
                        data={{
                            ...
                            tbody: [
                                ...
                                [{ text: <Row             text={it.L('Trading instruments')} /> },    { text: it.L('FX-majors (standard/micro lots),[_1]FX-minors, Commodities, Cryptocurrencies, Stocks, and Stock Indices', '<br />') }, { text: it.L('Synthetics') }],
                            ],
                        }}
                    />
                </div>
