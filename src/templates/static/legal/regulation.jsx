        ...
        <div className='static_full'>
            ...
            <div data-show='eucountry'>
                ...
                <Box header={it.L('Deriv (MX) Ltd')} >
                    <p>{it.L('Deriv (MX) Ltd, Millennium House, Level 1, Victoria Road, Douglas IM2 4RW, Isle of Man, is licensed and regulated in Great Britain by the Gambling Commission under [_1]account no. 39172[_3] and by the Gambling Supervision Commission in the Isle of Man ([_2]view licence[_3]).', '<a href="https://beta.gamblingcommission.gov.uk/public-register/business/detail/39172" target="_blank" rel="noopener noreferrer">', `<a href="https://${window.location.hostname.split('.').splice(1).join('.') || 'deriv.com'}/regulatory/Deriv_(MX)_Ltd.pdf" target="_blank" rel="noopener noreferrer">`, '</a>')}</p>
