...
const Tac = () => (
    <div>
        ...
        <p>{it.L('If the client account has been locked or suspended and has not recorded any transactions for a period of twelve months or more, the Company reserves the right to rescind the client account funds.')}</p>
        <p>{it.L('The client account funds will be rescinded if the client account has been inactive for 30 days with an account balance of USD/AUD/EUR/GBP1 or less.')}</p>
