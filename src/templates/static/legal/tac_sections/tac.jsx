...
const Tac = () => (
    <div>
        ...
        <p>{it.L('Your account funds will be rescinded if your account has been locked or has not recorded any transactions for a period of more than twelve months.')}</p>
        <p>{it.L('Your account funds will be rescinded if your account has been inactive for 30 days with an account balance of USD/AUD/EUR/GBP1 or less.')}</p>
