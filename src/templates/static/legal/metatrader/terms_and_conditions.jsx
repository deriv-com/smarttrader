...
const TermsAndConditions = () => (
    <div id='mt-tnc'>
                ...
                <ol>
                    ...
                    <li>{it.L('Trading rules')}
                        <ol>
                            ...
                            <li>{it.L('Parts of this clause may not apply to Synthetic Indices, basket indices, and derived FX.')}</li>
                        </ol>
                    </li>
                </ol>
            </li>
        ...
        <ol>
            ...
            <li>{it.L('The Company sources market data from prime brokers who act as liquidity providers, thus executing the client\'s transactions through a pool of aggregated liquidity from top tier banks. The services offered by the Company do not include physical delivery of foreign currency by the Company or the prime brokers to the client. The client acknowledges and agrees that such data is proprietary to the Company and any such provider, and the client will not retransmit, redistribute, publish, disclose, or display in whole or in part such data to third parties. The client represents and warrants that they will only use such data for purposes of facilitating their entry into transactions with the Company on the client\'s MT5 Real Account in accordance with this agreement and not for any other purpose. This clause does not apply to Synthetic Indices, basket indices, and derived FX.')}</li>
        </ol>
        ...
        <ol>
            ...
            <li>{it.L('This section on force majeure events does not apply to Synthetic Indices, basket indices, and derived FX.')}</li>
        </ol>
