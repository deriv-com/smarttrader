...
const PaymentAgents = () => (
    <div>
        ...
        <ol>
            <li>{it.L('This agreement is between Deriv (SVG) LLC (hereinafter referred to as "the Company" or "[_1]") and Payment Agent (hereinafter referred to as "the Agent"), both of whom agree to be bound by this agreement.', it.website_name)}</li>
        ...
        <ol>
            ...
            <li>{it.L('It is agreed that any withdrawals through the Agent shall be made as follows:')}
                <ul className='bullet'>
                    <li>{it.L('When the client requests a withdrawal from [_1] Client Account, such request shall automatically proceed, and, as a result, the requested sum shall be transferred from the [_1] Client Account to the [_1] Agent Account. However, it is noted that when the client reaches the client\'s withdrawal limit, a withdrawal request shall not automatically proceed before the required authentication process is conducted.', it.website_name)}</li>
        ...
        <ol>
            <li>{it.L('Application to become a payment agent is reviewed only if the applicant has a Binary.com account with a balance equal to or more than the minimum amount required for the applicant’s country of residence.')}</li>
            <li>{it.L('To meet the requirement in the previous clause, the applicant may deposit the required amount using any payment method, including another payment agent’s services, with the exception of Deriv P2P and credit or debit cards.')}</li>
            <li>{it.L('If the Agent has not been asked to meet a minimum account balance requirement upon application, the Agent will receive a 30-day notice to ensure the Agent’s Binary.com account balance meets the minimum balance requirement for the Agent’s country of residence. The Agent may not use credit or debit cards or Deriv P2P to top up the Agent’s Binary.com account for the purpose of meeting the minimum balance requirement. The Company reserves the right to withdraw the Agent’s payment agent status if the Agent does not meet this requirement within 30 days.')}</li>
            <li>{it.L('The Agent may not make withdrawals through the Cashier page or Deriv P2P unless the Company makes an exception at its sole discretion.')}</li>
            <li>{it.L('Agents may not use their Binary.com account for trading under any circumstances.')}</li>
            <li>{it.L('The Agent may not transfer funds to another Agent unless the Company makes an exception at its sole discretion.')}</li>
            ...
            <li>{it.L('The Agent shall not do the following:')}
                <ul className='bullet'>
                    ...
                    <li>{it.L('Abusively or fraudulently use, for any purpose, the Application Program Interface (API) of [_1].', it.website_name)}</li>
                </ul>
            </li>
        </ol>
        ...
        <ol>
            <li>
                ...
                <ul className='bullet'>
                    ...
                    <li>{it.L('Any information that the Agent has provided or will provide to the Company in relation to the Agent\'s financial position, domicile, or other matters is accurate and not misleading.')}</li>
        ...
        <ol>
            <li>{it.L('Each of the following events constitutes an "Event of Default":')}
                <ul className='bullet'>
                    ...
                    <li>{it.L('Where the Agent becomes incapable of paying their debts as they fall due, or is bankrupt or insolvent, as defined under any and all applicable bankruptcy or insolvency law where the Agent is an individual')}</li>
                    ...
                    <li>{it.L('Any event capable of having a material adverse effect on the Agent\'s ability to perform any of their duties and obligations in accordance with this agreement')}</li>
                </ul>
            </li>
        ...
        <ol>
            <li>{it.L('The Company is the sole owner of all rights, titles, or interests whatsoever in and to all [_1] electronic systems, including but not limited to any and all software, email, and email management software, along with any modifications.', it.website_name)}</li>
