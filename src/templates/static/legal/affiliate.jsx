...
const Affiliate = () => (
    <div>
        <h2 data-anchor='affiliate'>{it.L('[_1]\'s Affiliate Programme', it.website_name)}</h2>
        <ol className='reset_ol'>
            ...
            <ListNested
                ...
                items={[
                    { text: it.L('The Affiliate must provide such information to the licensee as they may reasonably require in order to be able to comply with their information reporting and other obligations[_1] to the UK Gambling Commission[_2].', '<span data-show="eucountry">','</span>') },
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('The Affiliate\’s advertisements and campaigns must not lead traffic directly to the Company\’s websites and must not include any URL containing the word "[_1]" or any variation thereof.', it.website_name)  },
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('Should these expenses not be covered by funds in the Affiliate\'s account, the Company reserves the right to investigate alternative means for obtaining payment. For example, should the Affiliate\'s account have generated purchasing accounts, the Company will hold payment of commission for these accounts until such a time as the account for damages has been cleared.') },
                ]}
            />
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('Payment of commission earned for the previous calendar month will be made as soon as practicable after the 15th day of each month.') },
                    ...
                    { text: it.L('An Affiliate who refers other Affiliates to the Company ("Master Affiliate") has an account to which each referred Affiliate\'s account ("Sub-affiliate Account") is tied. The Master Affiliate is not allowed to own or control any Sub-affiliate Accounts linked with the Master Affiliate\'s account. If the Company has reason to believe that the Master Affiliate has breached this term, the Company reserves the right to reverse or cancel any commissions to the Master Affiliate and/or terminate all business relationships with the Master Affiliate.') },
                ]}
            />
            ...
            <ListNested
                ...
                items={[
                    ...
                    { text: it.L('Any notice given or made under this Agreement to the Company shall be by email to [_1]partners@binary.com[_2]. The Company shall send the Affiliate any notices given or made under this Agreement to the email address supplied on the Affiliate\'s application form or such other email addresses as notified by the Affiliate to the Company.', '<a href="mailto:partners@binary.com">', '</a>') },
