...
const Api = () => (
    <div>
        ...
        <p>{it.L('This document (the "Agreement") sets out the terms and conditions ("Terms") between Deriv Services Ltd (“the Company”) and the person who registered for the [_1] Application Programming Interface (“the Programmer”).', it.website_name)}</p>
