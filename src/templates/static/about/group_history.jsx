        ...
        <div className='gr-padding-10'>
            <div className='timeline'>
                <UL items={[
                    ...
                    { className: 'event featured',       header: it.L('Deriv.com launched'),                   text: it.L('[_1] was launched as the next-generation online trading platform. [_2] and Deriv collectively handle over 200 million transactions, with a turnover of over 1 USD billion a year.', `<a target=\'_blank\' href=\'https://${window.location.hostname.split('.').splice(1).join('.') || 'deriv.com'}\' rel=\'noopener noreferrer\'>Deriv.com</a>`, it.website_name) },
                    ...
                    { className: 'event',                header: it.L('EGR Operator Award'),                                       text: it.L('[_1] takes home first prize in the Financial Trading Operator category at the prestigious 2015 EGR Operator Awards ceremony, hosted in London.', it.website_name) },
                    ...
                    { className: 'event right',    header: it.L('\'Financial Trading Operator of the Year\' award by eGaming Review'),         text: it.L('A panel featuring industry leaders awards BetOnMarkets.com \'Financial Trading Operator of the Year\' over two other finalists. It\'s a major victory for our brand and further recognition of our world-beating service. Ten years on, and going from strength to strength.') },
                    ...
                    { className: 'event',                header: it.L('Regent Markets granted US patent'),         text: it.L('The patent means Regent Markets is the recognised pioneer of binary trading. The patent helps protect our innovations.') },
