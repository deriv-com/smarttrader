        ...
        <div className='gr-padding-10'>
            <div className='timeline'>
                <UL items={[
                    ...
                    { className: 'event right',          header: it.L('1 million transactions/day'),                               text: it.L('[_1]\'s systems are now processing in excess of 1 million transactions/day (including demo accounts).', it.website_name) },
