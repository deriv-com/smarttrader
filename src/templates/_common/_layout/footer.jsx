            ...
            <div className='container' data-show='eucountry'>
                ...
                <div className='gr-row'>
                    <div className='gr-12'>
                        ...
                        <p>
                            {it.L('In the Isle of Man and the UK, digital options on synthetic indices are offered by Deriv (MX) Ltd, Millennium House, Level 1, Victoria Road, Douglas IM2 4RW, Isle of Man; licensed and regulated in Great Britain by (1) the Gambling Commission under [_1]account no. 39172[_3] and by (2) the Gambling Supervision Commission in the Isle of Man ([_2]view licence[_3]).', '<a href="https://www.gamblingcommission.gov.uk/public-register/business/detail/39172" target="_blank" rel="noopener noreferrer">', '<a href="https://deriv.com/regulatory/Deriv_(MX)_Ltd.pdf" target="_blank" rel="noopener noreferrer">', '</a>')}
                        </p>
                        <p>
                            {it.L('In the rest of the EU, digital options on synthetic indices are offered by Deriv (Europe) Limited, W Business Centre, Level 3, Triq Dun Karm, Birkirkara BKR 9033, Malta; licensed and regulated by (1) the Malta Gaming Authority ([_1]licence no. MGA/B2C/102/2000[_4]), by (2) the Gambling Commission for clients in Great Britain under [_2]account no. 39495[_4], and by (3) the Revenue Commissioners for clients in Ireland (licence no. 1010285). View complete [_3]Regulatory Information[_4].', `<a href=${it.url_for('download/regulation/MGA_licence.pdf')} target="_blank">`, '<a href="https://www.gamblingcommission.gov.uk/public-register/business/detail/39495" target="_blank" rel="noopener noreferrer">', `<a href="${it.url_for('regulation')}">`, '</a>')}
                        </p>
                    </div>
                </div>
                <div className='gr-row'>
                    ...
                    <div className='gr-12'>
                        <div className='risk-warning'>
                            ...
                            <p className='eu-only invisible'>
                                {it.L('CFDs are complex instruments and come with a high risk of losing money rapidly due to leverage. Between [_1] of retail investor accounts lose money when trading CFDs with Deriv Investments (Europe) Limited. You should consider whether you understand how CFDs work and whether you can afford to take the high risk of losing your money.', '74-89%')}
                            </p>
                        </div>
                    </div>
                </div>
