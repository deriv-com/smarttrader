            ...
            <div className='container' data-show='eucountry'>
                ...
                <div className='gr-row'>
                    <div className='gr-12'>
                        ...
                        <p>
                            {it.L('In the Isle of Man and the UK, Synthetic indices are offered by Deriv (MX) Ltd, Millennium House, Level 1, Victoria Road, Douglas IM2 4RW, Isle of Man; licensed and regulated in Great Britain by (1) the Gambling Commission under [_1]account no. 39172[_3] and by (2) the Gambling Supervision Commission in the Isle of Man ([_2]view licence[_3]).', '<a href="https://beta.gamblingcommission.gov.uk/public-register/business/detail/39172" target="_blank" rel="noopener noreferrer">', `<a href="https://${it.derivDomainName()}/regulatory/Deriv_(MX)_Ltd.pdf" target="_blank" rel="noopener noreferrer">`, '</a>')}
                        </p>
                        <p>
