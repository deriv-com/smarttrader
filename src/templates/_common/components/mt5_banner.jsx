...
const mt5Banner = () => (
    <a className='mt5_banner' data-show='-eucountry' target='_blank' rel='noopener noreferrer' href={`https://${it.derivDomainName()}/interim/dmt5/?utm_source=binary&utm_medium=referral&utm_campaign=deriv-launch&utm_content=binary-mt5-page`}>
