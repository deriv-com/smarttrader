...
const Frequency = () => (
    <React.Fragment>
        <Wrapper>
            ...
            <div className='reality-check__label'>{it.L('Would you like to check your statement first? [_1]Check Statement[_2]', '<a id="statement" className = "reality-check__label reality-check__label-link">', '</a>')}</div>
        </Wrapper>
    </React.Fragment>
);
