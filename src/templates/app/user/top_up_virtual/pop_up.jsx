...
const TopUpVirtualPopup = () => (
    <React.Fragment>
        <div id='top_up' className='gr-padding-10 gr-gutter'>
            ...
            <p id='top_up_message' />
            <p>{it.L('Do you want to top up for another [_1]? If not, you can do this later on the [_2]Cashier page[_3], too.', '$10,000.00', '<a id="top_up_cashier_redirect" href="https://app.deriv.com/cashier/">', '</a>')}</p>
            <form id='frm_confirm'>
