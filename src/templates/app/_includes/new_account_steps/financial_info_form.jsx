...
const TradingExperienceForm = () => (
    <Fieldset id='trading_experience_section' legend={it.L('Trading experience')} className='fieldset_margin_top invisible'>
...
const FinancialInfoForm = () => (
    <React.Fragment>
        <form id='financial_info_step_form' className='gr-padding-10'>
